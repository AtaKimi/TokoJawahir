    ...
    <div class="drawer-side">
        ...
        <ul
            ...
            @role('admin')
                ...
                <x-admin.sidebar.link>
                    <x-slot:href>{{ route('admin.store.index') }}</x-slot:href>
                    <x-slot:icon>
                        <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px"
                            fill="white">
                            <path
            ...
            @else
                <x-admin.sidebar.link>
                    <x-slot:href>{{ route('user.transaction.index') }}</x-slot:href>
                    <x-slot:icon>
                        <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px"
                            fill="undefined">
                            <path
                ...
                <x-admin.sidebar.link>
                    <x-slot:href>{{ route('user.buyback.index') }}</x-slot:href>
                    <x-slot:icon>
                        <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px"
                            fill="undefined">
                            <path d="M360-240 120-480l240-240 56 56-144 144h488v-160h80v240H272l144 144-56 56Z" />
